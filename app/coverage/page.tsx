...
export default function CoveragePage() {
  ...
  return (
    <main>
      <SiteNav />
      <header className="pageHero"><div><p className="eyebrow">DATA QUALITY</p><h1>Coverage</h1><p className="lead">取得不能や検証に失敗した値を0にせず欠測として可視化。ランキングや合計値を読む前に、どの媒体がどれだけ観測できているか確認できます。</p></div><span className="badge">{observed}/{attempted} trusted</span></header>
